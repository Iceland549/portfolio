    ...
    return (
        <div className='projects'>
            ...
            <article>
                ...
                <p>Renforcement des compétences en React, Redux et Node.js dans un projet complet alliant rigueur technique et élégance minimaliste.</p>
                <p>Ce projet a permis de renforcer les compétences en intégration front-end/back-end, en gestion d&apos;état avec Redux, en documentation d&apos;API avec Swagger, ainsi qu&apos;en développement full-stack avec Node.js, tout en cultivant une approche minimaliste et élégante.</p>
                ...
                <p>Implémentation de composants React pour une logique de présentation des données optimisée et une structure de code modulaire. Intégration de SASS pour une gestion élégante des styles CSS et d&apos;animations CSS pour améliorer l&apos;expérience utilisateur.</p>
                <p>Ce projet a permis de renforcer les compétences en React, React Router, SASS et animations CSS, tout en développant une application web interactive et visuellement attrayante.</p>
                ...
                <p>Rédaction d&apos;un cahier de recette détaillé pour documenter les scénarios de test unitaires et fonctionnels nécessaires à la vérification du bon fonctionnement du site. Utilisation de Yarn comme gestionnaire de packages et de Node.js pour exécuter le code JavaScript côté serveur, facilitant la gestion des dépendances et l&apos;exécution de tests locaux. Versionning du travail avec GitHub et utilisation de Visual Studio Code comme éditeur de code pour le développement et le débogage.</p>
                <p>Ce projet a permis de développer des compétences cruciales en débogage, en rédaction de cahiers de recette et en utilisation d&apos;outils tels que React Developer Tools, Yarn et Node.js, tout en appliquant une approche rigoureuse et méthodique pour assurer la qualité et la fiabilité du site web.</p>
                ...
                <p>Implémentation des améliorations proposées en modifiant directement le code du site, dans le but d&apos;optimiser les performances et l&apos;accessibilité pour un meilleur référencement sur les moteurs de recherche. Création d&apos;un rapport détaillé illustrant les résultats avant et après les modifications, comprenant des captures d&apos;écran des audits, des explications sur les changements apportés et leur impact sur le SEO et l&apos;accessibilité.</p>
                <p>Ce projet a permis de développer des compétences essentielles en optimisation du référencement (SEO) et de l&apos;accessibilité, tout en mettant en pratique des techniques d&apos;analyse et d&apos;amélioration des performances d&apos;un site web, contribuant ainsi à une meilleure expérience utilisateur et une plus grande visibilité en ligne.</p>
